...
class ScheduleReferenceClaimValidatorTest {
  ...
  @CsvSource({
    ...
    "3, ab12:bc24, CIVIL, 123, SCH/ABC-12.34, '^[a-zA-Z0-9/.\\-]{1,20}$', false",
    "4, ab12:bc24, CIVIL, 123, Schedule Ref, '^[a-zA-Z0-9/.\\-]{1,20}$', true",
    "5, ab12:bc24, CIVIL, 123, Schedule:Ref, '^[a-zA-Z0-9/.\\-]{1,20}$', true",
    "6, ab12:bc24, CRIME,,, '^[a-zA-Z0-9/.\\-]{1,20}$', false",
    "7, ab12:bc24, CRIME,, ABCD, '^[a-zA-Z0-9/.\\-]{1,20}$', false",
