...
class JsonSchemaValidatorTest {
  ...
  class ClaimValidationTests {
    ...
    @CsvSource({
      ...
      "suspectsDefendantsCount, '121', LEGAL HELP, Suspects Defendants Count must be less than 100",
      ...
      "uniqueCaseId, '  ', LEGAL HELP, Unique Case ID must be in the format DDMMYY/NNN, for example '010125/001'",
      "uniqueCaseId, '12/35', MEDIATION, Unique Case ID must be in the format DDMMYY/NNN, for example '010125/001'",
      ...
      "designatedAccreditedRepresentativeCode, 6, LEGAL HELP, Designated Accredited Representative Code must be a number from 1 to 5",
      ...
      "adviceTime, 99999999, LEGAL HELP, Advice Time must be a number",
      "travelTime, 99999999, LEGAL HELP, Travel Time must be a number",
      "waitingTime, 99999999, LEGAL HELP, Waiting Time must be a number",
      "netProfitCostsAmount, 1000000000, LEGAL HELP, Net Profit Costs Amount must be a number with no more than 2 decimal places",
      ...
      "adjournedHearingFeeAmount, 10, LEGAL HELP, Adjourned Hearing Fee Amount must be a number from 0 to 9",
