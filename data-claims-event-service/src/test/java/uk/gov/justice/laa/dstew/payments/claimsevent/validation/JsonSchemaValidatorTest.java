...
class JsonSchemaValidatorTest {
  ...
  class ClaimValidationTests {
    ...
    @CsvSource({
      ...
      "disbursementsVatAmount, 10.011, 'disbursements_vat_amount: must be multiple of 0.01 (provided value: 10.011)'",
      "netProfitCostsAmount, -0.01, 'net_profit_costs_amount: must have a minimum value of 0.0 (provided value: -0.01)'",
      "netProfitCostsAmount, 10.011, 'net_profit_costs_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "netCounselCostsAmount, 10.011, 'net_counsel_costs_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "travelWaitingCostsAmount, 10.011, 'travel_waiting_costs_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "netDisbursementAmount, 10.011, 'net_disbursement_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "netWaitingCostsAmount, 10.011, 'net_waiting_costs_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "costsDamagesRecoveredAmount, 10.011, 'costs_damages_recovered_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "detentionTravelWaitingCostsAmount, 10.011, 'detention_travel_waiting_costs_amount: must be multiple of 0.01 (provided value: 10.011)'",
      ...
      "feeCode, \"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890X\", 'fee_code: must be at most 10 characters long (provided value: \"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890X\")'",
      ...
      "policeStationCourtPrisonId, '20250101', 'police_station_court_prison_id: does not match the regex pattern ^(?=.*[A-Za-z])[A-Za-z0-9]{1,6}$ (provided value: 20250101)'",
      "policeStationCourtPrisonId, '202501', 'police_station_court_prison_id: does not match the regex pattern ^(?=.*[A-Za-z])[A-Za-z0-9]{1,6}$ (provided value: 202501)'",
      "policeStationCourtPrisonId, '', 'police_station_court_prison_id: does not match the regex pattern ^(?=.*[A-Za-z])[A-Za-z0-9]{1,6}$ (provided value: )'",
      ...
      "stageReachedCode, 'ABCDE', 'stage_reached_code: must be at most 4 characters long (provided value: ABCDE)'",
    ...
    void validateClaimIndividualInvalidFieldLegalHelp(
      ...
      log.info("Expected technical message: {}", technicalError);
      log.info("Expected display message: {}", displayMessage);
      assertThat(errors)
          .extracting(ValidationMessagePatch::getTechnicalMessage)
          .map("'%s'"::formatted)
          .anyMatch(
    ...
    @CsvSource({
      ...
      "client2Postcode, 'ABC12 BCD', 'client_2_postcode: does not match the regex pattern ^NFA|[A-Z]{1,2}[0-9][0-9A-Z]?\\s?[0-9][A-Z]{2}$ (provided value: ABC12 BCD)'",
      "genderCode, 'MF', 'gender_code: does not match the regex pattern ^([MFU])$ (provided value: MF)'",
      "genderCode, 'A', 'gender_code: does not match the regex pattern ^([MFU])$ (provided value: A)'",
      "genderCode, '1', 'gender_code: does not match the regex pattern ^([MFU])$ (provided value: 1)'",
      "genderCode, '*', 'gender_code: does not match the regex pattern ^([MFU])$ (provided value: *)'",
