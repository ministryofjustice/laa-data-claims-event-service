...
@DisplayName("Submission validation service integration tests for prod")
public class SubmissionValidationServiceProdIntegrationTest extends MockServerIntegrationTest {
