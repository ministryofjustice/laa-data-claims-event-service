...
public class EffectiveCategoryOfLawClaimValidatorITest extends ClaimValidationIntegrationTestBase {

  private static final String VALIDATOR_PATH =
      CLAIMS_BASE_PATH + "EffectiveCategoryOfLawClaimValidator/";

  static List<Arguments> claimsResponse() {
    return List.of(
        Arguments.of(SUBMISSION_LEGAL_HELP, "effective-category-of-law-valid.json", Set.of()),
        Arguments.of(
            SUBMISSION_LEGAL_HELP,
            "effective-category-of-law-invalid.json",
            Set.of("SCHEMA_VALIDATION_ERROR")));
  }

  @DisplayName(
      "EffectiveCategoryOfLaw claim validator - validate claim responses produce matching reports")
  ...
  @DisplayName("EffectiveCategoryOfLaw claim validator - should only produce expected error codes")
  @ParameterizedTest(name = "{1}")
  @MethodSource("claimsResponse")
