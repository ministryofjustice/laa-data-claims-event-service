...
public final class GetClaimsPactTest extends AbstractPactTest {
  ...
  RequestResponsePact getClaims200(PactDslWithProvider builder) {
    ...
    return builder
        ...
        .path("/api/v1/claims")
        .matchQuery("submission_id", UUID_REGEX, EXAMPLE_UUID)
        .matchQuery("office_code", "([A-Z0-9]{6})", "ABC123")
        .matchQuery("submission_statuses", enumValuesToRegex(SubmissionStatus.class), "CREATED")
        .matchQuery("fee_code", ANY_FORMAT_REGEX, "FEE123")
        .matchQuery("unique_file_number", ANY_FORMAT_REGEX, "UFN123")
        .matchQuery("unique_client_number", ANY_FORMAT_REGEX, "UCN123")
        .matchQuery("unique_case_id", ANY_FORMAT_REGEX, "UCI123")
        .matchQuery("claim_statuses", enumValuesToRegex(ClaimStatus.class), "READY_TO_PROCESS")
        .matchQuery("page", ANY_NUMBER_REGEX, "1")
        .matchQuery("size", ANY_NUMBER_REGEX, "10")
        .matchQuery("sort", "(asc|desc)", "asc")
