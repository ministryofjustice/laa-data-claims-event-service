...
@SpringBootTest(
    ...
    properties = {
      "laa.claims-api.url=http://localhost:1234",
      "laa.data-claims-api.url=http://localhost:1234"
    })
@PactConsumerTest
                          ...
                          details -> {
                            ...
                            details.minArrayLike(
                                ...
                                outcome -> {
                                  ...
                                  outcome.stringType("client_2_forename", "string");
                                  outcome.stringType("client_2_surname", "string");
                                  outcome.stringType("client_2_date_of_birth", "string");
                                  outcome.stringType("client_2_ucn", "string");
                                  outcome.stringType("client_2_post_code", "string");
                                  outcome.stringType("client_2_gender", "string");
                                  outcome.stringType("client_2_ethnicity", "string");
                                  outcome.stringType("client_2_disability", "string");
                                  outcome.booleanType("client_2_legally_aided", true);
